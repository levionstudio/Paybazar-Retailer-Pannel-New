...
export default function DTHRechargeReport() {
  ...
  const handleViewReceipt = (transaction: DTHRechargeTransaction) => {
  ...
  const handleDownloadReceipt = async () => {
    ...
    try {
      ...
      pdf.save(
        `dth-recharge-receipt-${selectedTransaction.dth_transaction_id}.pdf`
      );
    ...
    <div className="flex min-h-screen w-full bg-gray-50">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/90 text-sm mt-1">
                    Detailed DTH recharge transaction reports
                  </p>
                </div>
              </div>
      ...
      <Dialog open={isReceiptOpen} onOpenChange={setIsReceiptOpen}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>DTH Recharge Receipt</DialogTitle>
          </DialogHeader>
